            ...
            <div className="flex items-center bg-amazon_blue flex-grow py-2">
                ...
                <div className="text-white flex items-center space-x-6 mx-6 font-semibold whitespace-nowrap ">
                    ...
                    <div className="link relative flex items-center">
                        <span className="absolute top-0 right-0 md:right-10 h-4 bg-yellow-400 rounded-full">0</span>
                        <ShoppingCartIcon className="h-10" />
                        <p className="font-bold text-xs md:text-sm hidden md:inline-flex text-center">Basket</p>
                    </div>
                </div>
            </div>
            {/* Bottom nav */}
